...
#import "CoreDataDBHandler.h"

static CoreDataDBHandler *sharedManager = nil;

@implementation CoreDataDBHandler
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Telesto Basement App" withExtension:@"momd"];
